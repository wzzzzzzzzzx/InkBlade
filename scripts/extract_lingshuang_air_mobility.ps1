...
try {
    Export-Sprite $src "jump_01.png" `
        ([System.Drawing.Rectangle]::new(756, 14, 350, 512)) `
        ([System.Drawing.Rectangle]::new(132, 32, 504, 692))

    Export-Sprite $src "dodge_01.png" `
        ([System.Drawing.Rectangle]::new(1088, 126, 430, 350)) `
        ([System.Drawing.Rectangle]::new(54, 136, 660, 520))
} finally {
    $src.Dispose()
}
